...
instert_school = __import__('9-insert_school').insert_school
...
if __name__ == "__main__":
    ...
    j_students = [
            ...
            { 'name': "Sonia", 'topics': [{ 'title': "Algo", 'score': 14.7}, { 'title': "C", 'score': 8.8}, { 'title': "Python", 'score': 15.7}]},
    ...
    for student in students:
        print("[{}] {} - {}".format(student.get('_id'), student.get('name'), student.get('topic')))

    top_students = top_students(students_collection)
    for student in top_students:
        print("[{}] {} =. {}".format(students.get('_id'), students.get('name'), students.get('averageScore')))
